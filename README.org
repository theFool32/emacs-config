...
This is my private doom emacs configuration. Specifically configured for Python and LaTeX.
The configuration is based on [[https://github.com/ztlevi/doom-config][ztlevi/doom-config]] and [[https://github.com/50ways2sayhard/doom-config][50ways2sayhard/doom-config]].
...
# Clone my config
git clone https://github.com/theFool32/emacs-config ~/.doom.d
